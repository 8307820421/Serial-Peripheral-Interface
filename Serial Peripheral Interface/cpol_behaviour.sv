/*
 ...
 ----> Here clk edges (leading and trailing detected based upon the clk edges not sclk edges) as clk edges detection and sclk 
      generation happening in same conditional block.
